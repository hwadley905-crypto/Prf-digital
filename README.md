...
<label><input type="checkbox"> Airway clear</label>
<label><input type="checkbox"> Airway compromised</label>
<label><input type="checkbox"> Breathing adequate</label>
<label><input type="checkbox"> Respiratory distress</label>
<label><input type="checkbox"> Circulation stable</label>
<label><input type="checkbox"> Haemorrhage controlled</label>
<label><input type="checkbox"> Disability assessed</label>
<label><input type="checkbox"> Exposure completed</label>
</div>
</div>
...
<div class="checkbox-group">
<label><input type="checkbox"> Oxygen</label>
<label><input type="checkbox"> IV access</label>
<label><input type="checkbox"> Analgesia</label>
<label><input type="checkbox"> Anti-emetic</label>
<label><input type="checkbox"> Immobilisation</label>
<label><input type="checkbox"> Fluids</label>
...
<div class="checkbox-group">
<label><input type="checkbox"> Capacity present</label>
<label><input type="checkbox"> Capacity lacking</label>
<label><input type="checkbox"> Safeguarding concern</label>
<label><input type="checkbox"> Mental health crisis</label>
<label><input type="checkbox"> Alcohol involved</label>
<label><input type="checkbox"> Drugs involved</label>
</div>
</div>
