...
(() => {
  const init=()=>{
    ...
    yes.onclick=()=>{consent.classList.remove('open');loading.hidden=false;loading.style.display='flex';setTimeout(()=>{loading.hidden=true;loading.style.display='none';renderPending();page.hidden=false;page.style.display='block';document.body.classList.add('gp-history-open');},7000);};
